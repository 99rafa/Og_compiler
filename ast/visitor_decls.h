...
#include <cdk/ast/visitor_decls.h>
  ...
  virtual void do_address_node(og::address_node *const node, int lvl) = 0;
  ...
  virtual void do_left_index_node(og::left_index_node *const node, int lvl) = 0;
  ...
  void do_address_node(og::address_node *const node, int lvl);
  ...
  void do_left_index_node(og::left_index_node *const node, int lvl);
