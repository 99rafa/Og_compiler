...
namespace og {
  ...
  public:
    inline for_node(int lineno, cdk::sequence_node *inits, cdk::sequence_node *conditions,
     cdk::sequence_node *incrs, cdk::basic_node *block) :
        basic_node(lineno), _inits(inits), _conditions(conditions),_incrs(incrs), _block(block) {
    }
